          ...
          <View
            ...
            <View
              ...
              <View
                ...
                {/* Basic Information */}
                <Card className="mb-6 overflow-hidden rounded-xl border-gray-800 bg-gray-900">
                  <CardHeader className="border-b border-gray-800 bg-gradient-to-r from-gray-900 to-gray-800 p-6">
                  ...
                  <CardContent className="p-6">
                    ...
                    <View className="mb-6">
                      ...
                      {isEditing ? (
                        ...
                        <Text
                          style={{ color: '#9ca3af', fontSize: 14, marginTop: 8, lineHeight: 20 }}>
                      ...
                      <View
                        ...
                        <Switch
                          ...
                          onCheckedChange={(checked) =>
                            isEditing && setFormData({ ...formData, isActive: checked })
                          }
                          disabled={!isEditing}
                        />
                      </View>
