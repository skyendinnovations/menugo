...
class MenuAPI extends BaseAPI {
  ...
  async updateCategory(restaurantId: number, categoryId: number, data: { name?: string; displayOrder?: number }) {
  ...
  async createItem(restaurantId: number, data: {
    categoryId: number;
    name: string;
    price: string;
    description?: string;
  ...
  async updateVariant(restaurantId: number, variantId: number, data: { name?: string; price?: string }) {
